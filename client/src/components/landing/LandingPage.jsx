      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            <Link
              to="/sign-in"
              className="hidden sm:inline-block text-xs sm:text-sm font-semibold text-slate-700 hover:text-slate-900 px-3 py-1.5 rounded-lg hover:bg-slate-100/70 transition-colors"
            >
              Sign In
            </Link>
            <Link
              to="/sign-up"
              className="inline-flex items-center gap-1 text-xs sm:text-sm font-bold text-white bg-primary hover:bg-primary-hover px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl shadow-sm shadow-primary/25 transition-all hover:scale-[1.02] active:scale-[0.98] whitespace-nowrap"
            >
            ...
            >
              ...
              <div className="pt-2 border-t border-slate-100 grid grid-cols-2 gap-2">
                <Link
                  ...
                  className="w-full py-2.5 text-center rounded-xl border border-slate-200 text-slate-800 font-bold text-xs hover:bg-slate-50 active:bg-slate-100"
                >
                  Sign In
                </Link>
                <Link
                  to="/sign-up"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="w-full py-2.5 text-center rounded-xl bg-primary text-white font-bold text-xs shadow-sm shadow-primary/20 hover:bg-primary-hover active:scale-95"
                >
                  Get Started Free
                </Link>
              </div>
